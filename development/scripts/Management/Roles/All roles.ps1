  Function global:Add-PowerGUIVaultRoles {
  param ($obj)
  ...
  $ch.Script = '$g_login.WebServiceManager.AdminService.GetPermissionsByRoleId('+$_.Id+')'
...
$g_login.WebServiceManager.AdminService.GetAllRoles() | foreach {Add-PowerGUIVaultRoles $_}