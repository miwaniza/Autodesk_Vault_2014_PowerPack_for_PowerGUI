 Function global:Add-PowerGUIVaultGroup {
  ...
  $ch.Script = '$g_login.WebServiceManager.AdminService.GetGroupById('+$obj.Id+')'
  $ch.expand()
...
$groups = $g_login.WebServiceManager.AdminService.GetAllGroups() | foreach {Add-PowerGUIVaultGroup $_}
$groups