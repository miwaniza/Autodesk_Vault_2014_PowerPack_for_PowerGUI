 Function global:Add-PowerGUIVaultCustomEntitie {
  param ($obj)
...
$g_login.WebServiceManager.CustomEntityService.GetAllCustomEntityDefinitions() | foreach {Add-PowerGUIVaultCustomEntitie $_}